    ...
    <div className='h-screen relative overflow-hidden'>
      ...
      <div>
        <div className='fixed w-full z-10 bottom-0 translate-y-full bg-white px-3 py-8'>
          ...
          {/* yaha phr active:border-black  lagnai tha but not eokring with mycode time 4:54 */}
          <div className='flex w-full border-2 mb-2 rounded-xl items-center justify-between p-3'> 
           ...
           <div className='ml-2 w-1/2'>
            ...
            <p className='font-normal text-sm'>Affordable, Car rides</p>
           </div>
           <h2 className='text-lg font-semibold'>pkr300</h2>
          </div>
           ...
           <div className='ml-2 w-1/2'>
            ...
            <p className='font-normal text-sm'>Affordable,Auto Ride</p>
           </div>
           <h2 className='text-lg font-semibold'>pkr250</h2>
          </div>
